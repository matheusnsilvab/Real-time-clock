...
## 🚀 Funcionalidades
* **Relógio 24h:** Atualização precisa a cada segundo.
* **Data Completa:** Exibe o dia da semana e a data formatada.
* **Modo Tela Cheia:** Clique em qualquer lugar (apenas no PC) para expandir.
* **Responsivo:** Ajusta automaticamente o tamanho para Celulares, Tablets e Desktops.
